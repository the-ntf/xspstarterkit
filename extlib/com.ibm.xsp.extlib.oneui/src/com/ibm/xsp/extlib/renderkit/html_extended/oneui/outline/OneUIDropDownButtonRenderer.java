...
public class OneUIDropDownButtonRenderer extends OutlineDropDownButtonRenderer {

    @Override
    protected ITreeRenderer findTreeRenderer(FacesContext context, AbstractOutline outline) {
        return new com.ibm.xsp.extlib.renderkit.html_extended.oneui.outline.tree.OneUIDropDownButtonRenderer();
    }
}
