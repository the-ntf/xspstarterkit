...
public class OneUIApplicationLayoutRenderer extends AbstractApplicationLayoutRenderer {
    ...
    protected Object getProperty(int prop) {
        switch(prop) {
            ...
            case PROP_SEARCHBOXINACTIVETEXT:        return com.ibm.xsp.extlib.oneui.ResourceHandler.getString("AbstractApplicationLayoutRenderer.searchInactiveText"); // $NLS-AbstractApplicationLayoutRenderer.searchInactiveText-1$
            ...
            case PROP_SEARCHBUTTONALT:              return com.ibm.xsp.extlib.oneui.ResourceHandler.getString("AbstractApplicationLayoutRenderer.submit_search_alt"); // $NLS-AbstractApplicationLayoutRenderer.submit_search_alt-1$
