...
public class OneUIv302WidgetContainerRenderer extends OneUIWidgetContainerRenderer {
    ...
    protected void writeBodyScrollUp(FacesContext context, ResponseWriter w, UIWidgetContainer c) throws IOException {
        if(!c.isDisableScrollUp()) {
            ...
            w.writeAttribute("title",com.ibm.xsp.extlib.oneui.ResourceHandler.getString("WidgetContainerRenderer.Scrollup"),null); // $NON-NLS-1$ $NLS-WidgetContainerRenderer.Scrollup-2$
            ...
            w.writeAttribute("src", blankImg, null); // $NON-NLS-1$
    ...
    protected void writeBodyScrollDown(FacesContext context, ResponseWriter w, UIWidgetContainer c) throws IOException {
        if(!c.isDisableScrollDown()) {
            ...
            w.writeAttribute("title",com.ibm.xsp.extlib.oneui.ResourceHandler.getString("WidgetContainerRenderer.Scrolldown"),null); // $NON-NLS-1$ $NLS-WidgetContainerRenderer.Scrolldown-2$
