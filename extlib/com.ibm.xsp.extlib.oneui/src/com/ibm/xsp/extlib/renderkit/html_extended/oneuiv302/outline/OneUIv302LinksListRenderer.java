...
import com.ibm.xsp.extlib.renderkit.html_extended.oneui.outline.OneUILinksListRenderer;
...
public class OneUIv302LinksListRenderer extends OneUILinksListRenderer {
    ...
    protected ITreeRenderer findTreeRenderer(FacesContext context, AbstractOutline outline) {
        return new com.ibm.xsp.extlib.renderkit.html_extended.oneuiv302.outline.tree.OneUIv302LinksListRenderer(outline);
    }
