...
public class OneUIv302MenuRenderer extends OneUIMenuRenderer {
    ...
    protected void preRenderTree(FacesContext context, ResponseWriter writer, TreeContextImpl tree) throws IOException {
        ...
        writer.writeAttribute("aria-label", com.ibm.xsp.extlib.oneui.ResourceHandler.getString("OneUIv302MenuRenderer_NavAriaLabel_MenuNavigation"), null); // $NON-NLS-1$ // $NLS-OneUIv302MenuRenderer_NavAriaLabel_MenuNavigation-2$
