...
public class OneUIv3PlaceBarActionsRenderer extends OneUIv3TreePopupMenuRenderer {
    ...
    protected void renderPopupButton(FacesContext context, ResponseWriter writer, TreeContextImpl tree, boolean enabled, boolean selected) throws IOException {
        ...
        if(tree.getNode().getType()!=ITreeNode.NODE_LEAF) {
            ...
            writer.writeAttribute("aria-label",com.ibm.xsp.extlib.oneui.ResourceHandler.getString("OneUIv3PlaceBarActionsRenderer.ShowMenu"),null);  // $NON-NLS-1$ $NLS-OneUIv3PlaceBarActionsRenderer.ShowMenu-2$
            writer.writeAttribute("alt",com.ibm.xsp.extlib.oneui.ResourceHandler.getString("OneUIv3PlaceBarActionsRenderer.ShowMenu.1"),null);  // $NON-NLS-1$ $NLS-OneUIv3PlaceBarActionsRenderer.ShowMenu.1-2$
            writer.endElement("img"); // $NON-NLS-1$
