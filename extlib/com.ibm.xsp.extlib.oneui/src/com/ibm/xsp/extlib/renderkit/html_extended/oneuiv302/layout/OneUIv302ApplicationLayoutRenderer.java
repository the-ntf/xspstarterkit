...
public class OneUIv302ApplicationLayoutRenderer extends OneUIApplicationLayoutRenderer {
    ...
    protected Object getProperty(int prop) {
        switch(prop) {
            ...
            case PROP_BANNERLINKALT:                return com.ibm.xsp.extlib.oneui.ResourceHandler.getString("AbstractApplicationLayoutRenderer.SkiptomaincontentlinkAccesskeyS");  // $NLS-AbstractApplicationLayoutRenderer.SkiptomaincontentlinkAccesskeyS-1$;
            case PROP_BANNERROLE:                   return ""; // $NON-NLS-1$
            // -- Banner, Product Logo
            case PROP_PRODUCTLOGOCLASS:             return ""; // $NON-NLS-1$
            case PROP_PRODUCTLOGOSTYLE:             return "float:left;vertical-align:middle;margin-right: 5px;"; // $NON-NLS-1$
            ...
            case PROP_TITLEBARNAVARIALABEL:         return com.ibm.xsp.extlib.oneui.ResourceHandler.getString("OneUIv302ApplicationLayoutRenderer_TitleBarNavAriaLabel");// $NLS-OneUIv302ApplicationLayoutRenderer_TitleBarNavAriaLabel-1$
    ...
    protected void writeBannerContent(FacesContext context, ResponseWriter w, UIApplicationLayout c, BasicApplicationConfigurationImpl configuration) throws IOException {
        ...
        w.writeAttribute("aria-label", com.ibm.xsp.extlib.oneui.ResourceHandler.getString("OneUIv302ApplicationLayoutRenderer_BannerNavAriaLabel"), null); //$NON-NLS-1$ // $NLS-OneUIv302ApplicationLayoutRenderer_BannerNavAriaLabel-2$
