...
public class WidgetContainerRenderer extends FacesRendererEx {
    ...
    final private String _INITCLOSED = "_closed"; // $NON-NLS-1$
    final private String _CONTENTS = "_contents"; // $NON-NLS-1$
    final private String _OPENED = "_open"; // $NON-NLS-1$
    final private String _CLOSED = "_close"; // $NON-NLS-1$
    final private String _LKOPENED = "_lk_open"; // $NON-NLS-1$
    final private String _LKCLOSED = "_lk_close"; // $NON-NLS-1$
    final private String _TITLE = "_title"; // $NON-NLS-1$
