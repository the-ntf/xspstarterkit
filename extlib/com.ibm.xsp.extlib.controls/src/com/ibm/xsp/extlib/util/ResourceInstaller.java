...
public class ResourceInstaller {
    ...
    public void startInstall() throws IOException {
        ...
        String log = StringUtil.format(com.ibm.xsp.extlib.core.ResourceHandler.getSpecialAudienceString("ResourceInstaller.Installingcustomresourcesforlibra"),fileName); // $NLX-ResourceInstaller.Installingcustomresourcesforlibra-1$
...
//  }
    public void installResources(Bundle bundle, String resPath) throws IOException {
        ...
        if(url==null) {
            throw new IOException(StringUtil.format(com.ibm.xsp.extlib.core.ResourceHandler.getSpecialAudienceString("ResourceInstaller.Cannotfindresourcesentry0"),resPath)); // $NLX-ResourceInstaller.Cannotfindresourcesentry0-1$
        }
