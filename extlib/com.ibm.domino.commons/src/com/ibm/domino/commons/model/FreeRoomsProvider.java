...
public class FreeRoomsProvider implements IFreeRoomsProvider {
    ...
    public List<Room> getFreeRooms(Session session, String site, 
        ...
        try {
            ...
            throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("FreeRoomsProvider.Errorfindingroomsmatchingthesitea"), e); // $NLX-FreeRoomsProvider.Errorfindingroomsmatchingthesitea-1$
        }
        ...
        try {
            ...
            while ( iterator.hasNext() ) {
                ...
                try {
                    ...
                    Logger.get().warn(e, com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getLoggingString("warn.FreeRoomsProvider.Exceptionthrownsearchingfreetimef"), item); // $NLW-FreeRoomsProvider.Exceptionthrownsearchingfreetimef-1$
                }
    ...
    private List<Room> findMatchingRooms(Session session, String site, int capacity) 
        ...
        try {
            ...
            if( dirNav == null || dirNav.getCurrentMatches() == 0 ){
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("FreeRoomsProvider.Sitenotfound"), ModelException.ERR_NOT_FOUND); // $NLX-FreeRoomsProvider.Sitenotfound-1$
            }
