...
public class DelegateProvider implements IDelegateProvider {
    ...
    public Delegate get(Database database, String name) throws ModelException {
        ...
        try {
            ...
            throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Errorgettingdelegateaccess"), e); // $NLX-DelegateProvider.Errorgettingdelegateaccess-1$
        }
    ...
    public void set(Database database, Delegate delegate) throws ModelException {
        ...
        try {
            if ( StringUtil.isEmpty(delegate.getName()) ) {
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Adelegatemusthaveaname"), ModelException.ERR_INVALID_INPUT); // $NLX-DelegateProvider.Adelegatemusthaveaname-1$
            }
            ...
            throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Errorcreatingdelegate"), e); // $NLX-DelegateProvider.Errorcreatingdelegate-1$
        }
        finally {
    ...
    protected void setImpl(Database database, Delegate delegate, Document profile) throws ModelException, NotesException {
        ...
        try {
            if ( !hasManagerAccess(database) ) {
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Manageraccessisrequiredtomodifyad"), ModelException.ERR_NOT_ALLOWED); // $NLX-DelegateProvider.Manageraccessisrequiredtomodifyad-1$
            }
            ...
            if ( !updated ) {
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Delegatenotfound"), ModelException.ERR_NOT_FOUND); // $NLX-DelegateProvider.Delegatenotfound-1$
            }
        } 
        finally {
    ...
    public void add(Database database, Delegate delegate) throws ModelException {
        ...
        try {
            if ( StringUtil.isEmpty(delegate.getName()) ) {
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Adelegatemusthaveaname.1"), ModelException.ERR_INVALID_INPUT); // $NLX-DelegateProvider.Adelegatemusthaveaname.1-1$
            }
            ...
            throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Errorcreatingdelegate.1"), e); // $NLX-DelegateProvider.Errorcreatingdelegate.1-1$
        }
        finally {
            BackendUtil.safeRecycle(profile);
        }
    ...
    protected void addImpl(Database database, Delegate delegate, Document profile) throws ModelException, NotesException {
        ...
        try {
            if ( !hasManagerAccess(database) ) {
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Manageraccessisrequiredtoaddadele"), ModelException.ERR_NOT_ALLOWED); // $NLX-DelegateProvider.Manageraccessisrequiredtoaddadele-1$
            }
            ...
            while ( entry != null ) {
                ...
                if ( delegateName.equalsIgnoreCase(no.getAbbreviated()) ) {
                    throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Adelegateofthatnamealreadyexists"), ModelException.ERR_CONFLICT); // $NLX-DelegateProvider.Adelegateofthatnamealreadyexists-1$
                }
                entry = acl.getNextEntry();
            }
    ...
    public void delete(Database database, String name) throws ModelException {
        ...
        if ( Delegate.DEFAULT_NAME.equalsIgnoreCase(name) ) {
            throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Cannotremovethedefaultdelegate"), ModelException.ERR_NOT_ALLOWED); // $NLX-DelegateProvider.Cannotremovethedefaultdelegate-1$
        }
        ...
        try {
            ...
            throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Errordeletingdelegate"), e); // $NLX-DelegateProvider.Errordeletingdelegate-1$
        }
        finally {
            BackendUtil.safeRecycle(profile);
        }
    ...
    protected void deleteImpl(Database database, String name, Document profile) throws ModelException, NotesException {
        ...
        try {
            if ( !hasManagerAccess(database) ) {
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Manageraccessisrequiredtoremovead"), ModelException.ERR_NOT_ALLOWED); // $NLX-DelegateProvider.Manageraccessisrequiredtoremovead-1$
            }
            ...
            while ( entry != null ) {
                ...
                if ( name.equalsIgnoreCase(no.getAbbreviated()) ) {
                    ...
                    if ( owner != null && owner.equalsIgnoreCase(entry.getName()) ) {
                        throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Cannotremovetheownersaccess"), ModelException.ERR_NOT_ALLOWED); // $NLX-DelegateProvider.Cannotremovetheownersaccess-1$
                    }
            ...
            if ( !deleted ) {
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Delegatenotfound.1"), ModelException.ERR_NOT_FOUND); // $NLX-DelegateProvider.Delegatenotfound.1-1$
            }
        } 
        finally {
            BackendUtil.safeRecycle(acl);
    ...
    public List<Delegate> getList(Database database) throws ModelException {
        ...
        try {
            ...
            throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Errorgettingdelegatelist"), e); // $NLX-DelegateProvider.Errorgettingdelegatelist-1$
        }
    ...
    public DelegateAccess getEffectiveAccess(Database database) throws ModelException {
        ...
        try {
            ...
            if ( StringUtil.isEmpty(user) ) {
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Errorgettingeffectiveusername")); // $NLX-DelegateProvider.Errorgettingeffectiveusername-1$
            }
            ...
            throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Errorgettingeffectiveaccess"), e); // $NLX-DelegateProvider.Errorgettingeffectiveaccess-1$
        }
    ...
    private void aclEntryFromDelegate(Delegate delegate, ACLEntry entry) throws ModelException, NotesException {
        ...
        if ( what == DelegateAccess.What.NOTHING ) {
            if ( delegate.getType() != Delegate.Type.DEFAULT ) {
                throw new ModelException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("DelegateProvider.Adelegatemusthaveaccesstosomethin"), ModelException.ERR_INVALID_INPUT); // $NLX-DelegateProvider.Adelegatemusthaveaccesstosomethin-1$
            }
        }
