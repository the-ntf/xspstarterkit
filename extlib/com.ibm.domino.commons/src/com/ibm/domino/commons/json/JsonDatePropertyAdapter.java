    ...
    public DateProperty compose(Map<String, TimeZone> timeZones)  {
        ...
        try {
            if ( _dateValue == null ) {
                ...
                throw new ParseException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("JsonDatePropertyAdapter.Mustatleasthaveadatevalue"),0); // $NLX-JsonDatePropertyAdapter.Mustatleasthaveadatevalue-1$
                //return null;
            }
            ...
            if ( _timeValue == null ) {
                ...
                if (_utcValue && _tzidValue != null)
                    throw new ParseException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("JsonDatePropertyAdapter.Baddatetimeproperty"),0); // $NLX-JsonDatePropertyAdapter.Baddatetimeproperty-1$
                ...
                if ( _utcValue ) {
                    ...
                    if(tz==null){
                        throw new ParseException(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("JsonDatePropertyAdapter.TheTimezoneIDisnotfound"),0); // $NLX-JsonDatePropertyAdapter.TheTimezoneIDisnotfound-1$
                    }
                }
            }
