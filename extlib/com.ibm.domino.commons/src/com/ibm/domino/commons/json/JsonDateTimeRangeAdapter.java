        ...
        if ( JSON_START.equals(propertyName) ) {
            if ( value instanceof JsonDatePropertyAdapter ) {
                ...
                throw new JsonIllegalValueException(
                        MessageFormat.format(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("JsonDateTimeRangeAdapter.Parameter0invalidformat1"),propertyName, value.toString())); // $NLX-JsonDateTimeRangeAdapter.Parameter0invalidformat1-1$
            }
        }
            ...
            if ( value instanceof JsonDatePropertyAdapter ) {
                ...
                throw new JsonIllegalValueException(
                        MessageFormat.format(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("JsonDateTimeRangeAdapter.Parameter0invalidformat1.1"),propertyName, value.toString()));  // $NLX-JsonDateTimeRangeAdapter.Parameter0invalidformat1.1-1$
            }
        }
        else{
            throw new JsonIllegalValueException(
                    MessageFormat.format(com.ibm.domino.commons.internal.DominoCommonsResourceHandler.getSpecialAudienceString("JsonDateTimeRangeAdapter.Unsupportparameter0"), propertyName));                // $NLX-JsonDateTimeRangeAdapter.Unsupportparameter0-1$
        }
