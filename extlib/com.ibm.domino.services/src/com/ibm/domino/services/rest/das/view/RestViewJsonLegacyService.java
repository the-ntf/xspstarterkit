...
public class RestViewJsonLegacyService extends RestViewLegacyService {
    ...
    public void renderService() throws ServiceException {
        if (HTTP_GET.equalsIgnoreCase(getHttpRequest().getMethod())) {
            ...
            throw new ServiceException(null,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonLegacyService.Method0isnotallowedwithJSONformat"),getHttpRequest().getMethod()); // $NLX-RestViewJsonLegacyService.Method0isnotallowedwithJSONformat-1$
        }
    }
