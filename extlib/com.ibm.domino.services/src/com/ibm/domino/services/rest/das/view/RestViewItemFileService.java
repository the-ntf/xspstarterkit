...
public class RestViewItemFileService extends RestViewService {
    ...
    public void renderService() throws ServiceException {
        if (HTTP_GET.equalsIgnoreCase(getHttpRequest().getMethod())) {
            ...
            throw new ServiceException(null,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewItemFileService.Method0isnotallowedwithJSONformat"),getHttpRequest().getMethod()); // $NLX-RestViewItemFileService.Method0isnotallowedwithJSONformat-1$
        }
    }
    ...
    protected void renderServiceJSONPost() throws ServiceException {
        ...
        if(!reqContentType.contains(CONTENTTYPE_APPLICATION_JSON)) {
            throw new ServiceException(null,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewItemFileService.Requestdoesnotcontainsapplication"),reqContentType); // $NLX-RestViewItemFileService.Requestdoesnotcontainsapplication-1$
        }
        ...
        try {
            ...
            throw new ServiceException(ex,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewItemFileService.ErrorwhileparsingtheJSONcontent")); // $NLX-RestViewItemFileService.ErrorwhileparsingtheJSONcontent-1$
        }
        ...
        try {
            ...
            if(rows!=null) {
                try {
                    ...
                    throw new ServiceException(ex,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewItemFileService.Errorwhileupdatingdata")); // $NLX-RestViewItemFileService.Errorwhileupdatingdata-1$
                }
            }
        } catch (NotesException ex) {
            throw new ServiceException(ex,""); // $NON-NLS-1$
    ...
    private String msgErrorCreatingDocument() {
        return com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewItemFileService.Errorcreatingdocument.1"); // $NLX-RestViewItemFileService.Errorcreatingdocument.1-1$
    }
    ...
    private String msgErrorUpdatingData() {
        return com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewItemFileService.Errorupdatingdata.1"); // $NLX-RestViewItemFileService.Errorupdatingdata.1-1$
    }
    ...
    protected void deleteDocument(RestViewNavigator viewNav, RestDocumentNavigator docNav, String id, JsonJavaObject items) throws ServiceException, JsonException, IOException {
        if(!queryDeleteDocument(id)) {
            throw new ServiceException(null, com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewItemFileService.Errordeletingdocument")); // $NLX-RestViewItemFileService.Errordeletingdocument-1$
        }
    ...
    protected String findItemName(RestViewNavigator viewNav, String columnName) throws ServiceException {
        ...
        if(itemName==null) {
            throw new ServiceException(null,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewItemFileService.Thecolumn0doesntmapaDocumentfield"),columnName); // $NLX-RestViewItemFileService.Thecolumn0doesntmapaDocumentfield-1$
        }
