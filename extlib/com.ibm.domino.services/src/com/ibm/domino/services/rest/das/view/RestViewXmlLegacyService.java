...
public class RestViewXmlLegacyService extends RestViewLegacyService {
    ...
    public void renderService() throws ServiceException {
        if (HTTP_GET.equalsIgnoreCase(getHttpRequest().getMethod())) {
            ...
            throw new ServiceException(null,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewXmlLegacyService.Method0isnotallowedwithXMLformat"),getHttpRequest().getMethod()); // $NLX-RestViewXmlLegacyService.Method0isnotallowedwithXMLformat-1$
        }
    }
