...
public class RestViewJsonService extends RestViewService {
    ...
    public void renderService() throws ServiceException {
        ...
        if (HTTP_GET.equalsIgnoreCase(method)) {
            ...
            throw new ServiceException(null, ResponseCode.METHOD_NOT_ALLOWED, com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonService.Method0isnotallowedwithJSONRestSe"), method); // $NLX-RestViewJsonService.Method0isnotallowedwithJSONRestSe-1$
        }
    }
            ...
            if(!isIgnoreRequestParams()) {
                ...
                if (StringUtil.isNotEmpty(param)) {
                    try {
                        ...
                        throw new ServiceException(nfe, ResponseCode.BAD_REQUEST, com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonService.Invalidmaxparameter")); // $NLX-RestViewJsonService.Invalidmaxparameter-1$
                    }
                }
            }
    ...
    protected void renderServiceJSONUpdate(int op) throws ServiceException {
        ...
        if (op != DELETE) {
            ...
            if(!reqContentType.contains(CONTENTTYPE_APPLICATION_JSON)) {
                throw new ServiceException(null,ResponseCode.BAD_REQUEST,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonService.Requestdoesnotcontainsapplication"),reqContentType); // $NLX-RestViewJsonService.Requestdoesnotcontainsapplication-1$
            }
                ...
                if (op == PUT) {
                    if (isFolderOperation(json)) {
                        ...
                        if (getView().isFolder()) {
                            ...
                            throw new ServiceException(null,ResponseCode.BAD_REQUEST,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonService.Attemptingfolderoperationonaview"));  //$NLX-RestViewJsonService.Attemptingfolderoperationonaview-1$                   
                    }
                }
            } catch(Exception ex) {
                throw new ServiceException(ex,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonService.ErrorwhileparsingtheJSONcontent")); // $NLX-RestViewJsonService.ErrorwhileparsingtheJSONcontent-1$
            }
        }
        ...
        try {
            ...
            throw new ServiceException(ex,com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonService.Errorwhileupdatingdata")); // $NLX-RestViewJsonService.Errorwhileupdatingdata-1$
        } finally {
            if (docNav != null)
                docNav.recycle();
        }
    ...
    private String msgErrorCreatingDocument() {
        return com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonService.Errorcreatingdocument.3"); // $NLX-RestViewJsonService.Errorcreatingdocument.3-1$
    }
    ...
    private String msgErrorUpdatingData() {
        return com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonService.Errorupdatingdata.1"); // $NLX-RestViewJsonService.Errorupdatingdata.1-1$
    }
    ...
    private String msgErrorDeletingDocument() {
        return com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("RestViewJsonService.Errordeletingdocument.1"); // $NLX-RestViewJsonService.Errordeletingdocument.1-1$
    }
