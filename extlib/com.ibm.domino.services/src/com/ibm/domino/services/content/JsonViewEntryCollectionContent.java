...
//                  jsonWriter.endProperty();
    ...
    public void updateFolder(JsonJavaObject folderOperations) throws ServiceException {
        ...
        if ( errors > 0 ) {
            throw new ServiceException(new NotesException(), com.ibm.domino.services.ResourceHandler.getSpecialAudienceString("JsonViewEntryCollectionContent.Errorsperforming0of1folderoperati"), errors, operations.size()); // $NLX-JsonViewEntryCollectionContent.Errorsperforming0of1folderoperati-1$
        }
    }
