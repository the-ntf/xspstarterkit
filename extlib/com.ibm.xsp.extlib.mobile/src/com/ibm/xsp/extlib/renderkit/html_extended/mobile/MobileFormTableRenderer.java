  ...
  //getProperty is used as a property dispatcher. The intended use of getProperty
    ...
    protected Object getProperty(int prop) {
        switch(prop) {
            ...
            case PROP_ERRORSUMMARYMAINTEXT:     return com.ibm.xsp.extlib.mobile.ResourceHandler.getString("MobileFormTableRenderer.Error"); // $NLS-MobileFormTableRenderer.Error-1$
    ...
    protected void writeErrorSummaryButton(FacesContext context, ResponseWriter w, FormLayout c, String id, String shadeId) throws IOException {
        ...
        w.writeAttribute("value", com.ibm.xsp.extlib.mobile.ResourceHandler.getString("MobileFormTableRenderer_iphone.OK"), null); //$NON-NLS-1$ $NLS-MobileFormTableRenderer_iphone.OK-2$
        StringBuilder b = new StringBuilder();
