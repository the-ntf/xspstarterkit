...
public class LoginTreeNode extends BasicComplexTreeNode {
    ...
    public String getLabel() {
        ...
        return logged ? com.ibm.xsp.extlib.domino.ResourceHandler.getString("LoginTreeNode.Logout") : com.ibm.xsp.extlib.domino.ResourceHandler.getString("LoginTreeNode.Login"); // $NLS-LoginTreeNode.Logout-1$ $NLS-LoginTreeNode.Login-2$
    }
