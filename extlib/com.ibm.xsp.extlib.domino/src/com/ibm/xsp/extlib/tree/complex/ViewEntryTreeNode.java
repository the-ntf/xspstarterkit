...
public class ViewEntryTreeNode extends ComplexLeafTreeNode  {
    ...
    public ITreeNode.NodeIterator iterateChildren(int start, int count) {
        try {
            ...
            throw new FacesExceptionEx(ex,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("ViewEntryTreeNode.Errorwhilereadingthelistorviewsfo")); // $NLX-ViewEntryTreeNode.Errorwhilereadingthelistorviewsfo-1$
        }
    ...
    private class ListIterator implements ITreeNode.NodeIterator {
        ...
        private void moveToNext(boolean first) {
            ...
            try {
                ...
                throw new FacesExceptionEx(ex,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("ViewEntryTreeNode.Errorwhilereadingviewcontentforth")); // $NLX-ViewEntryTreeNode.Errorwhilereadingviewcontentforth-1$
            }
        }
