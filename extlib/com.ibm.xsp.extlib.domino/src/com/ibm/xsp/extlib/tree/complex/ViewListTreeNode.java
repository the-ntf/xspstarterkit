...
public class ViewListTreeNode extends ComplexLeafTreeNode {
    ...
    public ITreeNode.NodeIterator iterateChildren(int start, int count) {
        try {
            ...
            throw new FacesExceptionEx(ex, com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("ViewListTreeNode.Errorwhilereadingthelistorviewsfo")); // $NLX-ViewListTreeNode.Errorwhilereadingthelistorviewsfo-1$
        }
    }
        ...
        public String getLabel() {
            ...
            if (StringUtil.isEmpty(s)) {
                try {
                    s = view.getName();
                    if (StringUtil.isEmpty(s)) {
                        s = com.ibm.xsp.extlib.domino.ResourceHandler.getString("ViewListTreeNode.untitled"); // $NLS-ViewListTreeNode.untitled-1$
                    }
                } catch (NotesException ex) {
                }
            }
