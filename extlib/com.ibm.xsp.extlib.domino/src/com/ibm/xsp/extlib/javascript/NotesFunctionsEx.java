...
public class NotesFunctionsEx extends FBSDefaultObject {
    ...
    public static class NotesFunction extends BuiltinFunction {
        ...
        public FBSValue call(IExecutionContext context, FBSValueVector args, FBSObject _this)
            ...
            try {
                ...
                switch (index) {
                    ...
                    default: {
                        throw new InterpretException(null, StringUtil.format(
                                com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("NotesFunctionEx_InternalErrorUnknownFunction"), functionName)); // $NLX-NotesFunctionEx_InternalErrorUnknownFunction-1$
                    }
                ...
                throw new InterpretException(e, StringUtil.format(com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("NotesFunctionEx_ErrorExecutingFunction"), // $NLX-NotesFunctionEx_ErrorExecutingFunction-1$
                        functionName));
            }
            throw new InterpretException(null, StringUtil.format(com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("NotesFunctionEx_CannotEvaluateFunction"), functionName)); // $NLX-NotesFunctionEx_CannotEvaluateFunction-1$
        }
    }
    ...
    public static String normalizeSubject(String subject, int maxlength) {
        if (subject.length() > maxlength) {
            ...
            subject = com.ibm.xsp.extlib.domino.ResourceHandler.getString("NotesFunctionEx_SubjectUntitled"); // $NLS-NotesFunctionEx_SubjectUntitled-1$
        }
        return subject;
    }
    ...
    public static Document getDocument(Object var) {
        ...
        throw new FacesExceptionEx(null, com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("NotesFunctionEx_CannotFindNotesDocument"), var); // $NLX-NotesFunctionEx_CannotFindNotesDocument-1$
    }
    ...
    private static DominoDocument getDominoDocument(Object var) {
        ...
        throw new FacesExceptionEx(null, com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("NotesFunctionEx_CannotFindXPagesDocumentObject"), var); // $NLX-NotesFunctionEx_CannotFindXPagesDocumentObject-1$
    }
}
