...
public class ViewDesign {
    ...
    //System.out.println("    colSep:"+colDef.listSep);                     
                ...
                throw new FacesExceptionEx(ex,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("ViewDesign.Errorwhileaccessingview0"),view.toString()); // $NLX-ViewDesign.Errorwhileaccessingview0-1$
            }
        }
    }
