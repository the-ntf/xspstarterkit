...
public class DominoNABNamePickerData extends AbstractDominoViewPickerData implements INamePickerData {
    ...
    public String[] getSourceLabels() {
        try {
            ...
            if(StringUtil.isEmpty(sel) || sel.equals(NAB_ALL)) {
                ...
                throw new FacesExceptionEx(null,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("DominoNABNamePickerData.Unknownaddressbookselectiontype0"),sel); // $NLX-DominoNABNamePickerData.Unknownaddressbookselectiontype0-1$
            }
            
            return labels.toArray(new String[labels.size()]);
        } catch(NotesException ex) {
            throw new FacesExceptionEx(ex,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("DominoNABNamePickerData.Errorwhileretrievingtheproviderso")); // $NLX-DominoNABNamePickerData.Errorwhileretrievingtheproviderso-1$
        }
    }
    ...
    public abstract class _EntryMetaData extends EntryMetaData {
        ...
        protected View openView() throws NotesException {
            ...
            if(nabDb==null) {
                throw new FacesExceptionEx(null,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("DominoNABNamePickerData.Notabletofindavalidaddressbookfor")); // $NLX-DominoNABNamePickerData.Notabletofindavalidaddressbookfor-1$
            }
            // Find the view
            String viewName = getViewName();
            if(StringUtil.isEmpty(viewName)) {
                throw new FacesExceptionEx(null,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("DominoNABNamePickerData.Notabletofindaviewintheaddressboo")); // $NLX-DominoNABNamePickerData.Notabletofindaviewintheaddressboo-1$
            }
        ...
        protected Database findNAB() throws NotesException {
            ...
            if(sessNabs!=null && sessNabs.length>0) {
                if(StringUtil.isEmpty(sel) || sel.equals(NAB_ALL)) {
                    ...
                    throw new FacesExceptionEx(null,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("DominoNABNamePickerData.Unknownaddressbookselectiontype0.1"),sel); // $NLX-DominoNABNamePickerData.Unknownaddressbookselectiontype0.1-1$
                }
            } else {
