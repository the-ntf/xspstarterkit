...
public abstract class AbstractDominoViewPickerData extends ValueBindingObjectImpl implements IPickerData {
    ...
    public List<IPickerEntry> loadEntries(Object[] ids, String[] attributeNames) {
        try {
            ...
            throw new FacesExceptionEx(ex,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("AbstractDominoViewPickerData.Errorwhileloadingentry")); // $NLX-AbstractDominoViewPickerData.Errorwhileloadingentry-1$
        }
    }   
}
