            ...
            synchronized(getSyncObject()) {
                ...
                if(data==null) {
                    try {
                        ...
                        throw new FacesExceptionEx(ex,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("DominoUserBeanDataProvider.Errorwhileretrievingusernames")); // $NLX-DominoUserBeanDataProvider.Errorwhileretrievingusernames-1$
                    }
                }
            }
        }
