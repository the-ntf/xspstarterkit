            ...
            synchronized(getSyncObject()) {
                ...
                if(data==null) {
                    try {
                        ...
                        throw new FacesExceptionEx(ex,com.ibm.xsp.extlib.domino.ResourceHandler.getSpecialAudienceString("DominoDBUserBeanDataProvider.Errorwhileretrievingusernames")); // $NLX-DominoDBUserBeanDataProvider.Errorwhileretrievingusernames-1$
                    }
                }
            }
        }
