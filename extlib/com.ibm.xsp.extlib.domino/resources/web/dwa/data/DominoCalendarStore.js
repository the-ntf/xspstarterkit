...
// TODO MWD tmp resource - talk to Maire & DWA folk to reconcile with NotesCalendarStore.js
...
dojo.provide("dwa.data.DominoCalendarStore");

dojo.require("dojo.data.util.simpleFetch");
dojo.require("dwa.date.calendar");
dojo.require("dwa.common.notesValue");

dojo.declare("dwa.data.DominoCalendarStore", null, {
	//	summary:
...
//	},
	_fetchItems: function _fetchItems(request){
        ...
        // TODO fix, find ancestor form, rather than first on page.
		...
		//	console.log("start=" + oValueStart);
		//	console.log("end=" + oValueEnd);
		//
