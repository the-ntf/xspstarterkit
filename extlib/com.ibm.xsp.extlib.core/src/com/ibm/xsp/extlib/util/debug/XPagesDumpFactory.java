...
public class XPagesDumpFactory implements DumpAccessorFactory {
    ...
    public static class HttpServletRequestMap extends BasicDumpFactory.PropertyMap {
        public HttpServletRequestMap(DumpContext dumpContext, HttpServletRequest req) {
            ...
            addCategory(com.ibm.xsp.extlib.core.ResourceHandler.getString("XPagesDumpFactory.RequestFields")); // $NLS-XPagesDumpFactory.RequestFields-1$
            ...
            addCategory(com.ibm.xsp.extlib.core.ResourceHandler.getString("XPagesDumpFactory.RequestParameters"));  // $NLS-XPagesDumpFactory.RequestParameters-1$
            for( Enumeration e=req.getParameterNames(); e.hasMoreElements(); ) {
                String s = (String)e.nextElement();
                addValue("a:"+s,req.getParameter(s)); // $NON-NLS-1$
            }
            
            addCategory(com.ibm.xsp.extlib.core.ResourceHandler.getString("XPagesDumpFactory.RequestHeaders"));  // $NLS-XPagesDumpFactory.RequestHeaders-1$
            for( Enumeration e=req.getHeaderNames(); e.hasMoreElements(); ) {
                String s = (String)e.nextElement();
                addValue("h:"+s,req.getHeader(s)); // $NON-NLS-1$
            }
            
            addCategory(com.ibm.xsp.extlib.core.ResourceHandler.getString("XPagesDumpFactory.RequestAttributes"));  // $NLS-XPagesDumpFactory.RequestAttributes-1$
    ...
    public static class HttpSessionMap extends BasicDumpFactory.PropertyMap {
        public HttpSessionMap(DumpContext dumpContext, HttpSession session) {
            ...
            addCategory(com.ibm.xsp.extlib.core.ResourceHandler.getString("XPagesDumpFactory.SessionFields"));  // $NLS-XPagesDumpFactory.SessionFields-1$
            ...
            addCategory(com.ibm.xsp.extlib.core.ResourceHandler.getString("XPagesDumpFactory.SessionAttributes"));  // $NLS-XPagesDumpFactory.SessionAttributes-1$
