...
public class JavaDumpFactory implements DumpAccessorFactory {
    ...
    public static class JavaMap extends AbstractMap {
        ...
        public String getStringLabel() {
            if(instance.isEmpty()) {
                return com.ibm.xsp.extlib.core.ResourceHandler.getString("JavaDumpFactory.emptymap");  // $NLS-JavaDumpFactory.emptymap-1$
            }
            return null;
        }
        @Override
    ...
    public static class JavaBean extends AbstractMap {
        ...
        public String getStringLabel() {
            if(desc==null || desc.length==0) {
                return com.ibm.xsp.extlib.core.ResourceHandler.getString("JavaDumpFactory.nopublicproperty");  // $NLS-JavaDumpFactory.nopublicproperty-1$
            }
            return null;
        }
        ...
        for( int i=0; i<desc.length; i++ ) {
            if(StringUtil.equals(desc[i].getName(),key)) {
                try {
                    ...
                    if(read==null) {
                        return StringUtil.format("<error: No bean read method>"); // $NON-NLS-1$
                    } else {
                    ...
                    return StringUtil.format("<error: {0}>",e.getMessage()); // $NON-NLS-1$
                }
            }
        }
    ...
    public static class JavaObject extends AbstractMap {
        ...
        public String getStringLabel() {
            if(fields==null || fields.length==0) {
                return com.ibm.xsp.extlib.core.ResourceHandler.getString("JavaDumpFactory.nopublicfield");  // $NLS-JavaDumpFactory.nopublicfield-1$
            }
            return null;
        }
        @Override
        ...
        public Object getProperty(Object key) {
            ...
            return StringUtil.format("<unknown field: {0}>",key); // $NON-NLS-1$
        }
    }
