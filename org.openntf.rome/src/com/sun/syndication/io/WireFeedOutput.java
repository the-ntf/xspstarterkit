...
public class WireFeedOutput {
	 ...
	 * <p>
	 * If the feed encoding is not NULL, it will be used in the XML prolog encoding attribute. It is the responsibility of the developer to
	 * ensure that if the String is written to a character stream the stream charset is the same as the feed encoding property.
	 * <p>
	 * NOTE: This method delages to the 'Document WireFeedOutput#outputJDom(WireFeed)'.
	 * <p>
	 * 
	 * @param feed
	 *            Abstract feed to create XML representation from. The type of the WireFeed must match the type given to the FeedOuptut
	 *            constructor.
	 ...
	 * <p>
	 * If the feed encoding is not NULL, it will be used in the XML prolog encoding attribute. The platform default charset encoding is used
	 * to write the feed to the file. It is the responsibility of the developer to ensure the feed encoding is set to the platform charset
	 * encoding.
	 * <p>
	 * NOTE: This method delages to the 'Document WireFeedOutput#outputJDom(WireFeed)'.
	 * <p>
	 ...
	 * <p>
	 * If the feed encoding is not NULL, it will be used in the XML prolog encoding attribute. It is the responsibility of the developer to
	 * ensure the Writer instance is using the same charset encoding.
	 * <p>
	 * NOTE: This method delages to the 'Document WireFeedOutput#outputJDom(WireFeed)'.
	 * <p>
	 * 
	 ...
	 * 
	 * @param feed
	 *            Abstract feed to create W3C DOM document from. The type of the WireFeed must match the type given to the FeedOuptut
	 *            constructor.
	 ...
	 * 
	 * @param feed
	 *            Abstract feed to create JDOM document from. The type of the WireFeed must match the type given to the FeedOuptut
	 *            constructor.
