...
public class SyndFeedOutput {
	 ...
	 * 
	 * @param feed
	 *            Abstract feed to create XML representation from. The type of the SyndFeedImpl must match the type given to the FeedOuptut
	 *            constructor.
	 ...
	 * 
	 * @param feed
	 *            Abstract feed to create W3C DOM document from. The type of the SyndFeedImpl must match the type given to the FeedOuptut
	 *            constructor.
	 ...
	 * 
	 * @param feed
	 *            Abstract feed to create JDOM document from. The type of the SyndFeedImpl must match the type given to the FeedOuptut
	 *            constructor.
