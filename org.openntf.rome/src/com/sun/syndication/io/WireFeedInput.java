 ...
 * <p>
 * It accepts all flavors of RSS (0.90, 0.91, 0.92, 0.93, 0.94, 1.0 and 2.0) and Atom 0.3 feeds. Parsers are plugable (they must implement
 * the WireFeedParser interface).
 * <p>
...
public class WireFeedInput {
	 ...
	 * 
	 * @param validate
	 *            indicates if the input should be validated. NOT IMPLEMENTED YET (validation does not happen)
	 * 
	 */
