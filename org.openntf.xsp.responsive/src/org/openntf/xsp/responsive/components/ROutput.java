 ...
 * 
 */
public class ROutput extends UIOutput implements RComponent {
	private static final Logger log_ = Logger.getLogger(ROutput.class.getName());
	 ...
	 */
	@Override
	public void buildContents(FacesContext paramFacesContext, FacesComponentBuilder paramFacesComponentBuilder) throws FacesException {
		// TODO Auto-generated method stub
