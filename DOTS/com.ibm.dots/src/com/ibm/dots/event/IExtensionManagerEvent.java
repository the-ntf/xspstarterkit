...
/**
 * @author dtaieb Represent an Extension Manager event. Note: not all of these events are currently supported See ExtensionManagerBridge for
 *         information about the events that are currently supported
 */
public interface IExtensionManagerEvent {
